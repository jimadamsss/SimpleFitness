...
{ 
    ...
    if ( nil == color ) {
        ...
        color = (CPColor *)[[CPColor alloc] initWithCGColor:clear];
...
+(CPColor *)colorWithGenericGray:(CGFloat)gray
{
	...
	CPColor *color = (CPColor *)[[CPColor alloc] initWithCGColor:colorRef];
...
-(id)copyWithZone:(NSZone *)zone
{
    ...
    CPColor *colorCopy = (CPColor *)[[[self class] allocWithZone:zone] initWithCGColor:cgColorCopy];
